...
public class MusicRecorderRenderer implements BlockEntityRenderer<MusicRecorderEntity> {
    public MusicRecorderRenderer(BlockEntityRendererFactory.Context context) {
